import 'package:ekremtek_odev4_3ve6_arasini_yazdir/data/question_data.dart';
import 'package:ekremtek_odev4_3ve6_arasini_yazdir/models/quiz_end.dart';
import 'package:ekremtek_odev4_3ve6_arasini_yazdir/widgets/answer_button.dart';
...
class QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 157, 23, 190),
      body: Column(
